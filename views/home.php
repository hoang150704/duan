                                    ...
                                    <div class="col-lg-3">
                                        <div class="single_product">
                                            <div class="product_thumb">
                                                <a class="primary_img" href="product-details.html"><img  src="<?= BASE_URL .$AoThun['main_image']?>" alt="" id="main_image" ></a>
                                            ...
                                            <div class="product_content">
                                                <h3><a href="product-details.html"><?=$AoThun['product_name'] ?></a></h3>
