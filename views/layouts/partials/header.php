<header class="header_area header_three">
        <!--header top start-->
        <?php require_once PATH_VIEW. 'layouts/components/header_top.php'; ?>
        <!--header top start-->
            ...
            <div class="container-fluid">
                <div class="middel_inner">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="logo">
                                <a href="index.html"><img src="<?= BASE_URL ?>assets/user/theme_shop/assets/img/logo/logoHDT1.png" width="150px" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="cart_area">
