                    ...
                    <div class="col-md-8 order-1">
                        ...
                        <div class="row">
                            <div class="col mb-4">
                                ...
                                <input type="text" name="order_account_name" class="form-control" placeholder="Nguyễn Văn A" aria-label="First name">
                            </div>

                        </div>
                        <div class="mb-4">
                            <label for="Address">Địa chỉ</label>
                            <input type="text" name="order_address" class="form-control" placeholder="Địa chỉ nhận hàng" aria-label="Address">
                        </div>

                        <div class="mb-4">
                            <label for="Address2">Số điện thoại</label>
                            <input type="text" name="order_phone" class="form-control" placeholder="Số điện thoại" aria-label="Address2">
                        </div>
                        <hr class="mb-4">
