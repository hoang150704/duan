                        ...
                        <table>
                            ...
                            <tbody>
                                <?php if (!empty($_SESSION['cart'])) : ?>
                                    <?php $total = 0; foreach ($_SESSION['cart'] as $index => $cart) : ?>
                                        <?php $product = getProductById($cart['id']) ?>
                                        <tr id="product-<?= $index ?>">
                                            ...
                                            <td class="product_quantity">
                                                <input class="quantity-input" data-price="<?= $cart['price'] ?>" data-stock="<?= $product['quantity'] ?>" min="1" max="<?= $product['quantity'] ?>" value="<?= $cart['quantity'] ?>" type="number" name="quantity[<?= $index ?>]" >
                                    ...
                                    <?php $total += $cart['price'] * $cart['quantity']; endforeach ?>
                                <?php else : ?>
                                    <tr>
                                        <td></td>
                                        <td></td>
