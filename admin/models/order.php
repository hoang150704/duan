...
if (!function_exists('listAllForOrder')) {
    function listAllForOrder()
    {
        try {
            ...
            $sql = "SELECT `order_shop`.`id`, `order_shop`.`status_id`, `order_shop`.`account_id`, `order_shop`.`date_order`, `order_shop`.`total_money`, `order_shop`.`order_address`, `order_shop`.`order_phone`, `order_shop`.`order_account_name`, `status_order`.`status_order_name` AS `status_name`,`account`.`fullname` AS `fullname`
            FROM `order_shop`
